...
<body>
                            ...
                            <?php if (!empty($variants)) : ?>
                                <?php foreach ($variants as $variant) : ?>
                                    <tr id="variant-row-<?php echo $variant['variant_id']; ?>">
                                        ...
                                        <td>
                                            <div  id="add-stock-wrapper-<?php echo $variant['variant_id']; ?>">
    ...
    <form action="variants.php" method="POST" enctype="multipart/form-data">
    ...
    <form id="editForm" action="../../php/edit_variants.php" method="POST" enctype="multipart/form-data" onsubmit="return confirmEdit()">
    ...
    <script>
        function redirectToPrintPage() {
            ...
            window.open(`../Print_Table/tablePrintInvVar.php?category_id=${categoryId}`, '_blank');
        }
        ...
        function confirmDeleteProduct(variantId) {
            window.location.href = 'variants.php?delete_variant=' + variantId + '&category_id=<?php echo $category_id; ?>';
        }
        ...
        function populateEditForm(variant_id) {
            fetch(`../../php/get_variant.php?variant_id=${variant_id}`)
                ...
                .then(data => {
                    if (data.status === 'success') {
                        ...
                        document.getElementById('variantStockEdit').value = variant.variant_stock;
            ...
            fetch('../../php/add_stock.php', {
                ...
                .then(data => {
                    if (data.status === 'success') {
                        ...
                        const editVariantId = document.getElementById('variantIdEdit').value;
                        if (editVariantId == variantId) {
                            document.getElementById('variantStockEdit').value = newStock;
                        }
...
<label>Number of Stock(s)</label>
<div class="inpexp">
    <input type="number" name="variants[${variantCount}][stock]" spellcheck="false" placeholder="Enter Stock">
</div>
</div>
<div class="parexp">
<label>Supplier</label>
...
`;
        ...
        function populateSubCategories(categoryId) {
            ...
            fetch(`../../php/fetch_subcategory.php?category_id=${categoryId}`)
                .then(response => response.json())
                .then(data => {
