...
include_once "../../php/todeliver.php";
...
<body>
                        ...
                        <div class="tabletool">
                            ...
                            <div class="n">
                                ...
                                <div class="filterColumn">
                                    ...
                                    <div class="marjcol">
                                            <div class="colWrap" style="font-size: 15px; display:none;" >
                                                <div class="in">
                                                ...
                                                <div class="in">
                                                    <input type="radio" name="dueFilter" id="dueToday" value="dueToday">
                                                    <label for="dueToday">Due Today</label>
                                                </div>
                    ...
                    <div class="table table-pending">
                        <table>
                            <tr class="tableheader">
                                ...
                                <td style="display: none;">Downpayment</td>
                                <td style="display: none;">Remaining Balance</td>
                                <td>Regular/Rush</td>
                            ...
                            <?php if (empty($toDeliverOrders)): ?>
                                <tr>
                                    <td colspan="18">No orders to deliver.</td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($toDeliverOrders as $order): ?>
                                    ...
                                    <tr data-order-id="<?php echo htmlspecialchars($order['order']['order_id']); ?>">
                                        ...
                                        <td><?php echo htmlspecialchars($order['customer']['phone_number']); ?></td>
                                        ...
                                        <td style="display: none;">₱<?php echo number_format($order['order']['downpayment'], 2); ?></td>
                                        <td style="display: none;">₱<?php echo number_format($order['order']['total_amount'], 2); ?></td>
                                        ...
                                        <td>
                                            <button onclick="showConfirmModal('<?php echo htmlspecialchars($order['order']['order_id']); ?>', 'mark as Delivered')">Delivered</button>
                                        </td>
                                ...
                                <?php endforeach; ?>
                                <button class="tableButton" id="setToReceivedButton" onclick="updateSelectedOrdersStatus('Delivered')">Set to Delivered</button>
                                <button class="tableButton" id="setToCancelButton" onclick="updateSelectedOrdersStatus('Cancelled')">Cancel Orders</button>
                            <?php endif; ?>
                        </table>
    ...
    <script>
        function redirectToPrintPage() {
            ...
            let url = '../Print_Table/tablePrintToDeliver.php';
        ...
        document.getElementById('confirmYesBtn').addEventListener('click', function() {
            if (currentAction && currentOrderId) {
                ...
                let status;
                if (currentAction === 'mark as Delivered') {
                    status = 'Delivered';                                       
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filterTable() {
                ...
                tableRows.forEach(row => {
                    ...
                    const deliveryDateCell = row.querySelector('td:nth-last-child(8)');
                    const rushRegularCell = row.querySelector('td:nth-last-child(10)');

                    if (!deliveryDateCell || !rushRegularCell) {
                        console.error("Missing cells in row:", row);
                        return;
                    }
                    ...
                    if (dueFilterOption === 'pastDue' && deliveryDate) {
                        if (deliveryDate >= today) {
                            showRow = false;
                        }
                    } else if (dueFilterOption === 'dueToday' && deliveryDate) {
                        if (deliveryDate.getTime() !== today.getTime()) {
                            showRow = false;
                        }
                    } else if (dueFilterOption === 'almostDue' && deliveryDate) {
                    ...
                    console.log({
                        rowText,
                        deliveryDate: deliveryDateCell.textContent.trim(),
            ...
            document.querySelectorAll('input[name="dueFilter"], input[name="filterPendingReg"]').forEach(input => {
        ...
        function toggleStatusButtons() {
            const setToReceivedButton = document.getElementById('setToReceivedButton');
            const setToCancelButton = document.getElementById('setToCancelButton');

            if (selectedOrderIds.length > 0) {
                setToReceivedButton.style.display = 'inline-block';
                setToCancelButton.style.display = 'inline-block';
            } else {
                setToReceivedButton.style.display = 'none';
                setToCancelButton.style.display = 'none'
            }
        }
