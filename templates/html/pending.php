    ...
    <body>
                        ...
                        <div class="table table-pending">
                            <table>
                                <tr class="tableheader">
                                    ...
                                    <td style="display: none;">Cancel</td>
                                    <td>View</td>
                                    <td>Print</td>
                                </tr>
                                <?php foreach ($pendingOrders as $order_id => $order) : ?>
                                    ...
                                    <tr data-order-id="<?php echo htmlspecialchars($order['order']['order_id']); ?>">
                                        ...
                                        <td>
                                            <i class="fa-solid fa-print" onclick="populatePrintForm('<?php echo htmlspecialchars($order['order']['order_id']); ?>'); event.stopPropagation();"></i>
                                        </td>
                                ...
                                <?php endforeach; ?>
                                <button class="tableButton" id="setToDeliverButton" onclick="updateSelectedOrdersStatus('To Deliver')">Set to Deliver</button>
                                <button class="tableButton" id="cancelOrdersButton" onclick="updateSelectedOrdersStatus('Cancelled')">Cancel Orders</button>
                            </table>
        ...
        <script>
            ...
            function redirectToPrintPage() {
                ...
                let url = '../Print_Table/tablePrintPending.php';
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function filterTable() {
                    ...
                    tableRows.forEach(row => {
                        ...
                        const deliveryDateCell = row.querySelector('td:nth-child(13)');
            ...
            function toggleStatusButtons() {
                const setToDeliverButton = document.getElementById('setToDeliverButton');
                const cancelOrdersButton = document.getElementById('cancelOrdersButton');

                if (selectedOrderIds.length > 0) {
                    setToDeliverButton.style.display = 'inline-block';
                    cancelOrdersButton.style.display = 'inline-block';
                } else {
                    setToDeliverButton.style.display = 'none';
                    cancelOrdersButton.style.display = 'none';
                }
            }
