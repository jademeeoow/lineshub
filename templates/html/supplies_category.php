<?php
include_once "../../php/supplies_category.php";
...
<body>
    ...
    <div class="whole">
        ...
        <div class="con">
            ...
            <div class="content">
                <div class="title">
                    <h1> SUPPLIES CATEGORY</h1>
                </div>

                <div class="marjcontent">
                    <div class="categoryAddButton">
                        <button onclick="addCategory()">Add Supplies Category</button>
                        <button onclick="addProduct()">Add Supplies Product</button>
                    </div>
                    ...
                    <div class="option" id="optionAdd" style="display: none;">
                        <div class="opt opt1" id="optionAddOpt1">
                            <form action="supplies_category.php" method="POST" id="categoryForm">
                                <input type="hidden" name="add_category" value="1">
                                <div class="marjOption">
                                    <div class="addTitle">
                                        <p>Add Supplies Category</p>
                                        <i class="fas fa-times" onclick="closemyCategory()"></i>
                                    </div>
                                    <div class="parexp">
                        ...
                        <div class="opt opt2" id="optionAddOpt2">
                            <form action="supplies_category.php" method="POST" id="productForm">
                                <input type="hidden" name="add_product" value="1">
                                <div class="addproducts">
                                    <div class="addTitle">
                                        <p>Add Supplies Products</p>
                                        <i class="fas fa-times" onclick="closemyProduct()"></i>
                                    </div>
                                    <div class="parexp">
                                            ...
                                            <div class="containerPerVarviation" id="containerPerVarviation">
                                                ...
                                                <div class="conVar" data-index="0">
                                                    <div class="perVar">
                                                        ...
                                                        <div class="parexp">
                                                            <label>Number of Stock(s) ( indicate measurements : meters , centimeters etc)</label>
                                                            <div class="inpexp">
                    ...
                    <div class="option" id="optionEdit" style="display: none;">
                        <div class="opt opt1" id="optionEditOpt1">
                            <form action="supplies_category.php" method="POST" id="editCategoryForm">
        ...
        <script>
            ...
            function confirmDeleteCategory() {
                if (deleteCategoryId !== null) {
                    ...
                    fetch('../../php/delete_supplies_category.php', {
                            method: 'POST',
                            headers: {
                        ...
                        .catch(error => {
                            ...
                            document.getElementById('errorMessage').innerText = 'An error occurred while deleting the category.';
                            document.getElementById('errorModal').style.display = 'block';
                        });
            ...
            document.addEventListener("DOMContentLoaded", function() {
                function toggleEditInputs() {
                    // Get the container for subcategory inputs and the "No" radio button
            ...
            function closemyCategory() {
                ...
                if (categoryForm) {
                    categoryForm.reset(); // Clear form inputs
                }

                // Clear subcategory inputs
                const subcategoryInputs = document.querySelectorAll(".subCategoryInput");
                subcategoryInputs.forEach(input => {
                ...
                if (hasSubcategoriesNo) {
                    hasSubcategoriesNo.checked = true; // Set "No" as default
                }

                // Hide subcategory input section
            ...
            function closemyProduct() {
                ...
                const containerPerVariation = document.getElementById("containerPerVarviation");
                if (containerPerVariation) {
                    ...
                    const firstVariantInputs = containerPerVariation.querySelectorAll(".conVar:first-child input");
                    firstVariantInputs.forEach(input => {
                        input.value = "";
                    });


                    const supplierSelect = containerPerVariation.querySelector(".conVar:first-child select");
                    if (supplierSelect) {
...
`;
            ...
            function addVariations2(element) {
                ...
                let supplierOptions = '<option value="" disabled selected style="display: none;">Select Supplier</option>';
    ...
    `;
            ...
            function removeNoneSubcategory() {

                const subcategoryInputs = document.querySelectorAll('.subCategoryEditInput');


                if (subcategoryInputs.length > 0 && subcategoryInputs[0].value.trim().toLowerCase() === 'none') {

                    const parentConinput = subcategoryInputs[0].closest('.coninput');
                    if (parentConinput) {
                        parentConinput.remove();
                    }
                }
            }

            function redirectToSubcategory(categoryId) {
                window.location.href = `supplies_subcategory.php?category_id=${categoryId}`;
            }
        </script>
</body>
