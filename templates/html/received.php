...
<body>
                    ...
                    <div class="table table-pending">
                        <table>
                            ...
                            <?php if (empty($receivedOrders)): ?>
                                <tr>
                                    <td colspan="18">No received orders.</td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($receivedOrders as $order): ?>
                                    ...
                                    <tr data-order-id="<?php echo htmlspecialchars($order['order']['order_id']); ?>">
                                        ...
                                        <td>
                                            <button onclick="showConfirmModal('<?php echo htmlspecialchars($order['order']['order_id']); ?>', 'mark as Returned')">Returned</button>
                                        </td>
                                ...
                                <?php endforeach; ?>
                                <button class="tableButton" id="setToReturnedButton" onclick="updateSelectedOrdersStatus('Returned')">Set to Returned</button>
                            <?php endif; ?>
                        </table>
    ...
    <script>
        function redirectToPrintPage() {
            ...
            let url = '../Print_Table/tablePrintReceived.php';
        ...
        function showConfirmModal(orderId) {
            ...
            document.getElementById('confirmMessage').textContent = 'Are you sure you want to mark this order as Returned?';
        ...
        document.getElementById('confirmYesBtn').addEventListener('click', function() {
            if (currentOrderId) {
                fetch('../../php/update_order_status.php', {
                    ...
                    .then(data => {
                        if (data.success) {
                            showStatusModal('Order status updated to Returned successfully.', true);
                        } else {
        ...
        function toggleStatusButtons() {
            const setToReceivedButton = document.getElementById('setToReturnedButton');
