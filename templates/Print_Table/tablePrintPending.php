...
$filteredOrders = array_filter($pendingOrders, function($order) use ($fromDate, $toDate) {
...
<head>
    ...
    <title>Print Pending Orders</title>
        ...
        <div class="table">
            <table>
                ...
                <?php if (empty($filteredOrders)) : ?>
                    <tr>
                        <td colspan="9" style="text-align: center;">No pending orders found within the selected date range.</td>
                    </tr>
                <?php endif; ?>
            </table>
        </div>
