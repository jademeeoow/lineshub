...
$filteredOrders = array_filter($receivedOrders, function($order) use ($fromDate, $toDate) {
...
<head>
    ...
    <title>Print Received Orders</title>
        ...
        <div class="table">
            <table>
                ...
                <?php if (empty($filteredOrders)) : ?>
                    <tr>
                        <td colspan="7" style="text-align: center;">No received orders found within the selected date range.</td>
                    </tr>
                <?php endif; ?>
            </table>
        </div>
