...
$filteredOrders = array_filter($cancelledOrders, function($order) use ($fromDate, $toDate) {
...
<head>
    ...
    <title>Print Cancelled Orders</title>
        ...
        <div class="table">
            <table>
                ...
                <?php if (empty($filteredOrders)) : ?>
                    <tr>
                        <td colspan="7" style="text-align: center;">No cancelled orders found within the selected date range.</td>
                    </tr>
                <?php endif; ?>
            </table>
        </div>
