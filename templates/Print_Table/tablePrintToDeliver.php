...
// Optional date filtering (replace these with actual values or parameters from your form)
$fromDate = isset($_GET['fromDate']) ? $_GET['fromDate'] : null;
$toDate = isset($_GET['toDate']) ? $_GET['toDate'] : null;

// Filter orders based on date if provided
$filteredOrders = array_filter($toDeliverOrders, function ($order) use ($fromDate, $toDate) {
        ...
        <div class="table">
            <table>
                ...
                <?php if (empty($filteredOrders)) : ?>
                    <tr>
                        <td colspan="7" style="text-align: center;">No orders found for delivery within the selected date range.</td>
                    </tr>
                <?php endif; ?>
            </table>
        </div>
